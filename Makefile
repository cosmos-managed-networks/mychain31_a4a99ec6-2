...
HTTPS_GIT := github.com/mygithub/mychain31.git
...
ldflags = -X github.com/cosmos/cosmos-sdk/version.Name=mychain31 \
...
ifeq (,$(shell which heighliner))
	...
	heighliner build -c mychain31 --local -f chains.yaml
endif
